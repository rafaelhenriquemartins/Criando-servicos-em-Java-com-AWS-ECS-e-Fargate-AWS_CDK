...
public class Service02Stack extends Stack {
    ...
    public Service02Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic) {
        ...
        DeadLetterQueue productEventsQueue = (DeadLetterQueue) Queue.Builder.create(this, "ProductEvents")
                .queueName("product-events")
                .deadLetterQueue(deadLetterQueue)
                .build();

        SqsSubscription sqsSubscription = SqsSubscription.Builder.create((IQueue) productEventsQueue).build();
...
//                + ":3306/aws_project02?createDatabaseIfNotExist=true");
//        envVariables.put("SPRING_DATASOURCE_USERNAME", "admin");
//        envVariables.put("SPRING_DATASOURCE_PASSWORD", Fn.importValue("rds-password"));
        envVariables.put("AWS_REGION", "us-east-1");
        envVariables.put("AWS_SQS_QUEUE_PRODUCT_EVENTS_NAME", ((IQueue) productEventsQueue).getQueueName());
        ...
        ApplicationLoadBalancedFargateService service02 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB02")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("siecola/curso_aws_project02:1.0.0"))
                                .containerPort(9090)
        ...
        ((IQueue) productEventsQueue).grantConsumeMessages(service02.getTaskDefinition().getTaskRole());
    }
}
